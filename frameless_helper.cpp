...
{
public:
    WidgetData(FramelessHelperPrivate *d, QWidget *pTopLevelWidget);
    ~WidgetData();
    QWidget* widget();
...
//    m_pWidget->setWindowFlags(Qt::FramelessWindowHint|Qt::WindowStaysOnTopHint);
...
void WidgetData::handleMouseDoubleClickEvent(QMouseEvent *event)
{
//    qDebug()<<Q_FUNC_INFO;
